...
export class GetMintedNFTsRequest {
    /**
    * The ID of the candy machine
    */
    'candyMachineId': string;
    'network'?: GetMintedNFTsRequestNetworkEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "network",
            "baseName": "network",
            "type": "GetMintedNFTsRequestNetworkEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return GetMintedNFTsRequest.attributeTypeMap;
    }
...
export type GetMintedNFTsRequestNetworkEnum = "devnet" | "mainnet-beta" ;
