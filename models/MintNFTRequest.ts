...
export class MintNFTRequest {
    ...
    */
    'candyMachineContractVersion'?: MintNFTRequestCandyMachineContractVersionEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "MintNFTRequestCandyMachineContractVersionEnum",
            "format": ""
        }    ];
...
export type MintNFTRequestCandyMachineContractVersionEnum = "v1" | "v2" ;
