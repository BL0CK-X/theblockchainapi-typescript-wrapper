...
export class BalanceRequest {
    ...
    */
    'unit'?: BalanceRequestUnitEnum;
    'network'?: BalanceRequestNetworkEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "unit",
            "baseName": "unit",
            "type": "BalanceRequestUnitEnum",
            "format": ""
        },
        {
            "name": "network",
            "baseName": "network",
            "type": "BalanceRequestNetworkEnum",
            "format": ""
        },
        {
            "name": "mintAddress",
...
export type BalanceRequestUnitEnum = "lamport" | "sol" ;
export type BalanceRequestNetworkEnum = "devnet" | "mainnet-beta" ;
