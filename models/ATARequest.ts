    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "network",
            "baseName": "network",
            "type": "ATARequestNetworkEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ATARequest.attributeTypeMap;
    }
...
export type ATARequestNetworkEnum = "devnet" | "mainnet-beta" ;
