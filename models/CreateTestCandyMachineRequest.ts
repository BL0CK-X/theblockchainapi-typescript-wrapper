...
export class CreateTestCandyMachineRequest {
    /**
    ...
    */
    'passphrase'?: string;
    'network'?: CreateTestCandyMachineRequestNetworkEnum;
    /**
    * The contract you want to use to create the candy machine
    */
    'candyMachineContractVersion'?: CreateTestCandyMachineRequestCandyMachineContractVersionEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "network",
            "baseName": "network",
            "type": "CreateTestCandyMachineRequestNetworkEnum",
            "format": ""
        },
        {
            "name": "candyMachineContractVersion",
            "baseName": "candy_machine_contract_version",
            "type": "CreateTestCandyMachineRequestCandyMachineContractVersionEnum",
            "format": ""
        },
        {
            "name": "includeGatekeeper",
            "baseName": "include_gatekeeper",
            "type": "boolean",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return CreateTestCandyMachineRequest.attributeTypeMap;
    }
...
export type CreateTestCandyMachineRequestNetworkEnum = "devnet" | "mainnet-beta" ;
export type CreateTestCandyMachineRequestCandyMachineContractVersionEnum = "v1" | "v2" ;
