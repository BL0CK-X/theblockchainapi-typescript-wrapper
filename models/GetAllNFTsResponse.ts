...
export class GetAllNFTsResponse {
    ...
    */
    'mintedNfts'?: Array<GetAllNFTsResponseMintedNfts>;
    /**
    * The unminted NFTs. Only filled in for `v1` candy machines. Left empty for `v2`.
    */
    'unmintedNfts'?: Array<GetAllNFTsResponseUnmintedNfts>;
    /**
    * The list of all NFTs. Filled in for both `v1` and `v2` NFTs.
    */
    'allNfts'?: Array<GetAllNFTsResponseUnmintedNfts>;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "mintedNfts",
            "baseName": "minted_nfts",
            "type": "Array<GetAllNFTsResponseMintedNfts>",
            "format": ""
        },
        {
            "name": "unmintedNfts",
            "baseName": "unminted_nfts",
            "type": "Array<GetAllNFTsResponseUnmintedNfts>",
            "format": ""
        },
        {
            "name": "allNfts",
    ...
    static getAttributeTypeMap() {
        return GetAllNFTsResponse.attributeTypeMap;
    }
