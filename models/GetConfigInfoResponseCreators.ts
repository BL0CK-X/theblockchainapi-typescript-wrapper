...
export class GetConfigInfoResponseCreators {
    /**
    * Public key address of a creator
    */
    'address'?: string;
    /**
    * The share of the royalty that the creator receives
    */
    'share'?: number;
    ...
    static getAttributeTypeMap() {
        return GetConfigInfoResponseCreators.attributeTypeMap;
    }
