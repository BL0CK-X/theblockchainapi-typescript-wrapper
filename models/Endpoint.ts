...
export class Endpoint {
    ...
    */
    'inputSpecification': Array<ParameterSpecification>;
    /**
    ...
    * A list of dictionaries. Each dictionary describes one parameter for the input, including the name, type, required boolean, and description values of that parameter.
    */
    'outputSpecification': Array<ParameterSpecification>;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "baseName": "input_specification",
            "type": "Array<ParameterSpecification>",
            "format": ""
        },
        {
            "name": "inputExamples",
            "baseName": "input_examples",
            "type": "any",
            "format": ""
        },
        {
            "name": "outputSpecification",
            "baseName": "output_specification",
            "type": "Array<ParameterSpecification>",
            "format": ""
        },
        {
            "name": "outputExamples",
            "baseName": "output_examples",
            "type": "any",
            "format": ""
        }    ];
