...
import { CCPaymentBlockchainPaymentDetails } from './CCPaymentBlockchainPaymentDetails';
...
export class CCPayment {
    ...
    */
    ...
    'blockchainPaymentDetails'?: CCPaymentBlockchainPaymentDetails;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "blockchainPaymentDetails",
            "baseName": "blockchain_payment_details",
            "type": "CCPaymentBlockchainPaymentDetails",
            "format": ""
        },
        {
            "name": "customerId",
        ...
        {
            "name": "paymentValidationCode",
            "baseName": "payment_validation_code",
            "type": "string",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return CCPayment.attributeTypeMap;
    }
