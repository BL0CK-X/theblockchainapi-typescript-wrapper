    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "network",
            "baseName": "network",
            "type": "ListNFTsRequestNetworkEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ListNFTsRequest.attributeTypeMap;
    }
...
export type ListNFTsRequestNetworkEnum = "devnet" | "mainnet-beta" ;
