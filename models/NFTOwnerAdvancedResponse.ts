...
import { NFTOwnerAdvancedResponseContract } from './NFTOwnerAdvancedResponseContract';
import { HttpFile } from '../http/http';

export class NFTOwnerAdvancedResponse {
    'contract'?: NFTOwnerAdvancedResponseContract;
    /**
    ...
    */
    'state'?: NFTOwnerAdvancedResponseStateEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "contract",
            "baseName": "contract",
            "type": "NFTOwnerAdvancedResponseContract",
            "format": ""
        },
        {
            "name": "owner",
        ...
        },
        {
            "name": "state",
            "baseName": "state",
            "type": "NFTOwnerAdvancedResponseStateEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return NFTOwnerAdvancedResponse.attributeTypeMap;
    }
...
export type NFTOwnerAdvancedResponseStateEnum = "loaning" | "listing" | "staking" | "holding" | "burned" ;
