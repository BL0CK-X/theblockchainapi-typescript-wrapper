...
export class BalanceResponse {
    ...
    */
    'decimals'?: number;
    'network': BalanceResponseNetworkEnum;
    /**
    * Not included if retreiving an SPL token/NFT balance
    */
    'unit'?: BalanceResponseUnitEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "network",
            "baseName": "network",
            "type": "BalanceResponseNetworkEnum",
            "format": ""
        },
        {
            "name": "unit",
            "baseName": "unit",
            "type": "BalanceResponseUnitEnum",
            "format": ""
        }    ];
...
export type BalanceResponseNetworkEnum = "devnet" | "mainnet-beta" ;
export type BalanceResponseUnitEnum = "lamport" | "sol" ;
