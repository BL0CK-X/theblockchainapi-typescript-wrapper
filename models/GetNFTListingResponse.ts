...
export class GetNFTListingResponse {
    /**
    * The ID of the exchange where the NFT is listed 
    */
    'exchange'?: GetNFTListingResponseExchangeEnum;
    /**
    * A readable version of the exchange ID 
    */
    'exchangeReadable'?: string;
    /**
    * The signature of the listing transaction 
    */
    'listingTransactionSignature'?: string;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "exchange",
            "baseName": "exchange",
            "type": "GetNFTListingResponseExchangeEnum",
            "format": ""
        },
        {
        ...
        {
            "name": "listingTransactionSignature",
            "baseName": "listing_transaction_signature",
            "type": "string",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return GetNFTListingResponse.attributeTypeMap;
    }
...
export type GetNFTListingResponseExchangeEnum = "solsea" ;
