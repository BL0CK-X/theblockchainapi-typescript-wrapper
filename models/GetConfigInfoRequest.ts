...
export class GetConfigInfoRequest {
    /**
    ...
    */
    ...
    'network'?: GetConfigInfoRequestNetworkEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "network",
            "baseName": "network",
            "type": "GetConfigInfoRequestNetworkEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return GetConfigInfoRequest.attributeTypeMap;
    }
...
export type GetConfigInfoRequestNetworkEnum = "devnet" | "mainnet-beta" ;
