...
export class UploadFileRequest {
    'uploadMethod'?: UploadFileRequestUploadMethodEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            ...
            "type": "UploadFileRequestUploadMethodEnum",
            "format": ""
        }    ];
...
export type UploadFileRequestUploadMethodEnum = "IPFS" | "Arweave" | "Filecoin" ;
