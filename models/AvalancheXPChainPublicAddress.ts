...
export class AvalancheXPChainPublicAddress {
    /**
    ...
    */
    'hexPublicAddress'?: string;

    static readonly discriminator: string | undefined = undefined;

    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "bechPublicAddress",
            "baseName": "bech_public_address",
            "type": "string",
            "format": ""
        },
        {
            "name": "hexPublicAddress",
            "baseName": "hex_public_address",
            "type": "string",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return AvalancheXPChainPublicAddress.attributeTypeMap;
    }
