...
export class GetCandyMachineIDRequest {
    /**
    * The address of the NFT. NOT the mint authority address
    */
    'mintAddress': string;
    'network'?: GetCandyMachineIDRequestNetworkEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "network",
            "baseName": "network",
            "type": "GetCandyMachineIDRequestNetworkEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return GetCandyMachineIDRequest.attributeTypeMap;
    }
...
export type GetCandyMachineIDRequestNetworkEnum = "devnet" | "mainnet-beta" ;
