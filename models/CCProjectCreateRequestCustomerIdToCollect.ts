...
*/
export class CCProjectCreateRequestCustomerIdToCollect {
    /**
    ...
    */
    'idType': CCProjectCreateRequestCustomerIdToCollectIdTypeEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "idType",
            "baseName": "id_type",
            "type": "CCProjectCreateRequestCustomerIdToCollectIdTypeEnum",
            "format": ""
        },
        {
            "name": "name",
    ...
    static getAttributeTypeMap() {
        return CCProjectCreateRequestCustomerIdToCollect.attributeTypeMap;
    }
...
export type CCProjectCreateRequestCustomerIdToCollectIdTypeEnum = "misc" | "email" ;
