...
*/
export class CCPaymentBlockchainPaymentDetails {
    /**
    * The chain on which the payment was made. 
    */
    'chain'?: CCPaymentBlockchainPaymentDetailsChainEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "chain",
            "baseName": "chain",
            "type": "CCPaymentBlockchainPaymentDetailsChainEnum",
            "format": ""
        },
        {
            "name": "feeAmount",
    ...
    static getAttributeTypeMap() {
        return CCPaymentBlockchainPaymentDetails.attributeTypeMap;
    }
...
export type CCPaymentBlockchainPaymentDetailsChainEnum = "solana" ;
