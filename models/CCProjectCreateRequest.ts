...
*/
export class CCProjectCreateRequest {
    /**
    ...
    */
    'logoUrl'?: string;
    'customerIdToCollect'?: CCProjectCreateRequestCustomerIdToCollect;
    /**
    ...
    */
    'successUrl'?: string;
    'payoutMethod'?: CCProjectCreateRequestPayoutMethod;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "customerIdToCollect",
            "baseName": "customer_id_to_collect",
            "type": "CCProjectCreateRequestCustomerIdToCollect",
            "format": ""
        },
        {
            "name": "successUrl",
        ...
        },
        {
            ...
            "type": "CCProjectCreateRequestPayoutMethod",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return CCProjectCreateRequest.attributeTypeMap;
    }
