...
export class GetCandyDetailsRequest {
    /**
    * The ID of the candy machine 
    */
    'candyMachineId': string;
    'network'?: GetCandyDetailsRequestNetworkEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "network",
            "baseName": "network",
            "type": "GetCandyDetailsRequestNetworkEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return GetCandyDetailsRequest.attributeTypeMap;
    }
...
export type GetCandyDetailsRequestNetworkEnum = "devnet" | "mainnet-beta" ;
