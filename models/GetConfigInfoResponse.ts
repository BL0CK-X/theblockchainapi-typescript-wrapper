...
export class GetConfigInfoResponse {
    'authority'?: string;
    'creators'?: Array<GetConfigInfoResponseCreators>;
    'isMutable'?: boolean;
    /**
    * A public key address
    */
    'retainAuthority'?: string;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "creators",
            "baseName": "creators",
            "type": "Array<GetConfigInfoResponseCreators>",
            "format": ""
        },
        {
            "name": "isMutable",
    ...
    static getAttributeTypeMap() {
        return GetConfigInfoResponse.attributeTypeMap;
    }
