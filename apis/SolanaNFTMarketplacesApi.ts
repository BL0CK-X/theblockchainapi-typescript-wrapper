...
export class SolanaNFTMarketplacesApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param buyRequest 
     */
    public async solanaBuyNFT(network: 'devnet' | 'mainnet-beta', exchange: 'magic-eden', mintAddress: string, buyRequest?: BuyRequest, _options?: Configuration): Promise<RequestContext> {
     ...
     * @param delistRequest 
     */
    public async solanaDelistNFT(network: 'devnet' | 'mainnet-beta', exchange: 'magic-eden', mintAddress: string, delistRequest?: DelistRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     * @param listRequest 
     */
    public async solanaListNFT(network: 'devnet' | 'mainnet-beta', exchange: 'magic-eden', mintAddress: string, listRequest?: ListRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
