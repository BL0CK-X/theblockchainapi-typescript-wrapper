...
export class ObservableProjectApi {
     ...
     */
    public createProjectVersion(UNKNOWN_PARAMETER_NAME: , UNKNOWN_PARAMETER_NAME2: , _options?: Configuration): Observable<Project> {
        const requestContextPromise = this.requestFactory.createProjectVersion(UNKNOWN_PARAMETER_NAME, UNKNOWN_PARAMETER_NAME2, _options);
     ...
     * @param UNKNOWN_PARAMETER_NAME The ID of the project. Created and returned when a project is created.
     */
    public deleteProject(UNKNOWN_PARAMETER_NAME: , _options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.deleteProject(UNKNOWN_PARAMETER_NAME, _options);
     ...
     * @param UNKNOWN_PARAMETER_NAME2 The version of the project.
     */
    public deleteProjectVersion(UNKNOWN_PARAMETER_NAME: , UNKNOWN_PARAMETER_NAME2: , _options?: Configuration): Observable<Project> {
        const requestContextPromise = this.requestFactory.deleteProjectVersion(UNKNOWN_PARAMETER_NAME, UNKNOWN_PARAMETER_NAME2, _options);
     ...
     * @param UNKNOWN_PARAMETER_NAME The ID of the project. Created and returned when a project is created.
     */
    public getProject(UNKNOWN_PARAMETER_NAME: , _options?: Configuration): Observable<Project> {
        const requestContextPromise = this.requestFactory.getProject(UNKNOWN_PARAMETER_NAME, _options);
     ...
     * @param UNKNOWN_PARAMETER_NAME The ID of the project. Created and returned when a project is created.
     */
    public getProjectDeploymentStatus(UNKNOWN_PARAMETER_NAME: , _options?: Configuration): Observable<any> {
        const requestContextPromise = this.requestFactory.getProjectDeploymentStatus(UNKNOWN_PARAMETER_NAME, _options);
     ...
     */
    public getProjectDeploymentURL(UNKNOWN_PARAMETER_NAME: , UNKNOWN_BASE_TYPE?: UNKNOWN_BASE_TYPE, _options?: Configuration): Observable<ProjectDeploymentURL> {
        const requestContextPromise = this.requestFactory.getProjectDeploymentURL(UNKNOWN_PARAMETER_NAME, UNKNOWN_BASE_TYPE, _options);
     ...
     * @param UNKNOWN_PARAMETER_NAME The ID of the project. Created and returned when a project is created.
     */
    public getProjectStats(UNKNOWN_PARAMETER_NAME: , _options?: Configuration): Observable<Array<StatItem>> {
        const requestContextPromise = this.requestFactory.getProjectStats(UNKNOWN_PARAMETER_NAME, _options);
     ...
     * @param projectCreateRequest 
     */
    public updateProject(UNKNOWN_PARAMETER_NAME: , projectCreateRequest?: ProjectCreateRequest, _options?: Configuration): Observable<Project> {
        const requestContextPromise = this.requestFactory.updateProject(UNKNOWN_PARAMETER_NAME, projectCreateRequest, _options);
     ...
     * @param UNKNOWN_PARAMETER_NAME2 The version of the project.
     */
    public updateProjectDocumentation(UNKNOWN_PARAMETER_NAME: , UNKNOWN_PARAMETER_NAME2: , _options?: Configuration): Observable<Project> {
        const requestContextPromise = this.requestFactory.updateProjectDocumentation(UNKNOWN_PARAMETER_NAME, UNKNOWN_PARAMETER_NAME2, _options);
...
export class ObservableSolanaNFTMarketplacesApi {
     ...
     */
    public solanaGetNFTMarketplaceAnalytics(nFTAnalyticsRequest?: NFTAnalyticsRequest, _options?: Configuration): Observable<NFTAnalyticsResponse> {
        const requestContextPromise = this.requestFactory.solanaGetNFTMarketplaceAnalytics(nFTAnalyticsRequest, _options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.solanaGetNFTMarketplaceAnalytics(rsp)));
            }));
    }
     ...
     */
    public solanaGetNFTMarketplaceMarketShare(_options?: Configuration): Observable<any> {
        const requestContextPromise = this.requestFactory.solanaGetNFTMarketplaceMarketShare(_options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.solanaGetNFTMarketplaceMarketShare(rsp)));
            }));
    }
     ...
     */
    public solanaGetNFTMarketplaceRecentTransactions(_options?: Configuration): Observable<Array<NFTTransaction>> {
        const requestContextPromise = this.requestFactory.solanaGetNFTMarketplaceRecentTransactions(_options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.solanaGetNFTMarketplaceRecentTransactions(rsp)));
            }));
    }
